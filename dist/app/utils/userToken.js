...
const createUserToken = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVars.JWT.JWT_SECRET, env_1.envVars.JWT.JWT_ACCESS_EXPIRES);
    const refreshToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVars.JWT.JWT_REFRESH_SECRET, env_1.envVars.JWT.JWT_REFRESH_SECRET_EXPIRES);
    return {
        accessToken,
        refreshToken
    };
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const verifiedToken = (0, jwt_1.verifyToken)(refreshToken, env_1.envVars.JWT.JWT_REFRESH_SECRET);
    if (!jwt_1.verifyToken) {
        throw new appError_1.default(http_status_codes_1.default.BAD_REQUEST, "Refresh token is not valid");
    }
    ...
    const newAccessToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVars.JWT.JWT_SECRET, env_1.envVars.JWT.JWT_ACCESS_EXPIRES);
